    ...
    <div className="min-h-screen flex flex-col selection:bg-slate-900 selection:text-white">
          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            <Link to="/" className="group flex items-center gap-3">
              ...
              <div className="flex flex-col -space-y-1">
                ...
                <span className="text-[9px] font-bold text-slate-400 tracking-widest uppercase font-mono">Sovereign Vault</span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-2 sm:gap-6">
              <nav className="hidden md:flex items-center gap-1 bg-slate-100/50 p-1 rounded-xl border border-slate-200/40">
                ...
                <NavItem to="/entries" label="Ledger" />
                <NavItem to="/settings" label="Vault" />
              </nav>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-t border-slate-200/50 pb-safe">
        <div className="flex items-center justify-around h-16">
          ...
          <MobileNavItem to="/entries" label="Ledger" icon={<><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /></>} />
          <MobileNavItem to="/settings" label="Vault" icon={<><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z" /></>} />
        </div>
      </div>
      ...
      <footer className="w-full py-8 border-t border-slate-200/40 bg-slate-50/50">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-6">
          <div className="flex flex-col items-center sm:items-start gap-1">
            <span className="text-[11px] font-bold text-slate-900 tracking-tighter">RISK LEDGER PROTOCOL</span>
            <span className="text-[9px] font-bold text-slate-400 tracking-widest uppercase font-mono">End-to-End Local Encryption</span>
          </div>
          <nav className="flex items-center gap-6">
            ...
            <Link to="/entries" className="text-[11px] font-bold text-slate-400 hover:text-slate-900 transition-colors uppercase tracking-widest">Ledger</Link>
            <Link to="/settings" className="text-[11px] font-bold text-slate-400 hover:text-slate-900 transition-colors uppercase tracking-widest">Vault</Link>
          </nav>
        </div>
        <div className="mt-8 text-center">
          <p className="text-[9px] font-bold text-slate-300 tracking-widest uppercase font-mono">© 2026 Sovereign Systems • Ver 1.2.4</p>
        </div>
      </footer>
    </div>
  );
...
function PWAInstallButton() {
  ...
  if (isInstalled) return (
    <div className="flex items-center gap-1.5 px-2 py-1 bg-emerald-50 text-emerald-700 rounded-full border border-emerald-100 opacity-60">
      ...
      <span className="text-[9px] font-bold uppercase tracking-widest hidden sm:inline">Secured</span>
    </div>
  );
  ...
  if (!isInstallable) return (
    ...
    >
      ...
      <span className="hidden sm:inline">Setup Vault</span>
